...
namespace TMPro
{
	...
	public class TMP_Settings : ScriptableObject
	{
		...
		public static TMP_Settings instance
		{
			get
			{
				if (s_Instance == null && HFFResources.instance != null && HFFResources.instance.TMPSettings != null)
				{
					s_Instance = HFFResources.instance.TMPSettings;
				}
				if (s_Instance == null)
				{
					s_Instance = new TMP_Settings();
				}
				return s_Instance;
			}
		}
		...
		public static TMP_Settings LoadDefaultSettings()
		{
			if (s_Instance == null)
			{
				TMP_Settings tMPSettings = HFFResources.instance.TMPSettings;
				if (tMPSettings != null)
				{
					s_Instance = tMPSettings;
				}
			}
			return s_Instance;
		}
