...
namespace InControl
{
	public class PlayerAction : OneAxisInputControl
	{
		...
		public InputDevice ActiveDevice => (activeDevice != null) ? activeDevice : InputDevice.Null;

		private bool LastInputTypeIsDevice => LastInputType == BindingSourceType.DeviceBindingSource || LastInputType == BindingSourceType.UnknownDeviceBindingSource;
